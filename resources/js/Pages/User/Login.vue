                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-5">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input v-model="form['LoginForm[rememberMe]']" type="checkbox" class="w-4 h-4 text-primary-600 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-primary-500 cursor-pointer" />
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Remember Me</span>
                                </label>
                            </div>

                            <button type="submit" class="w-full login-btn text-white py-3 rounded-lg text-lg font-semibold cursor-pointer" :disabled="form.processing">Login</button>
                        </form>
