                ...
                <div class="w-full md:w-7/12">
                    <div class="p-6 lg:p-8">
                        <div class="text-center mb-6">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">A link to reset your password will be sent to your email</p>
                        </div>
                        ...
                        <p class="text-center mt-4 text-sm text-gray-500 dark:text-gray-400">
                            Remember your password? <Link href="/user/login" class="text-primary-600 dark:text-primary-400 hover:underline">Login</Link>
                        </p>
