      ...
      <div class="flex flex-col md:flex-row">
        ...
        <div class="hidden md:flex md:w-5/12 login-brand-panel text-white">
          <div class="flex flex-col justify-between p-6 lg:p-8 w-full">
            ...
            <div>
              <h2 class="font-display font-bold mb-3 text-[1.75rem] leading-tight">Create Your<br />Account</h2>
              <p class="opacity-75 text-[0.9rem]">Join us and start building amazing applications with Yii2.</p>
            </div>
          </div>
        </div>
        ...
        <div class="w-full md:w-7/12">
          <div class="p-6 lg:p-8">
            <div class="text-center mb-6">
              <h1 class="text-2xl font-bold mb-1 text-gray-900 dark:text-white">Create a new account</h1>
              <p class="text-sm text-gray-500 dark:text-gray-400">Fill out the fields below to get started</p>
            </div>

            <form @submit.prevent="submit">
              <div class="mb-4">
                <label for="signup-username" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1"
                  >Your Username</label
                >
                <div
                  :class="[
              ...
              <div class="mb-4">
                <label for="signup-email" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1"
                  >Your Email</label
                >
                <div
                  :class="[
              ...
              <div class="mb-5">
                <label for="signup-password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1"
                  >Your Password</label
                >
                <div
                  :class="[
            ...
            <div class="mt-6">
              ...
              <p class="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="/user/login" class="font-semibold text-primary-600 dark:text-primary-400 hover:underline">
                  Login
                </Link>
              </p>
            </div>
